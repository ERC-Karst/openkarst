...
def main():
    ...
    flowrate = 0.1       # Volumetric inflow in m^3/s
    water_depth = 0.01   # Fixed water depth at outlet in m

    # Apply constant inflow BC on left (volumetric, active from t=0 to end)
    ...
    # Apply fixed water depth BC on right
